<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_Inbox.aspx.cs" Inherits="RES4U__Latest.User_Inbox" %>
...
<head runat="server">
  ...
  <link href="Review_Page/assets/css/User_inbox.css" rel="stylesheet"/>
...
<body>
  ...
  <main id="main">
    ...
    <section id="comments" class="posts">
      <div class="container" data-aos="fade-up">
        <div id="messages_con" class="messages__wrap">No messages yet</div>      
      </div>
    </section>
  ...
  <script src="Review_Page/assets/js/User_inbox_js.js"></script>
</form> 
</body>
</html>
