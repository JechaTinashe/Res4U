<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Accounts_Page.aspx.cs" Inherits="RES4U__Latest.Accounts_Page" %>
<!DOCTYPE html>
...
<head runat="server">
  ...
  <link href="Review_Page/assets/css/Accounts_page.css" rel="stylesheet"/>
...
<body>
				...
				<div class="account-settings">
					<div class="user-profile">
						<div class="user-avatar">
							<img src="Review_Page/assets/img/profile.png" alt="Gumpo"/>
						</div>
						<h5 class="user-name">Cebolenkosi Gumpo</h5>
						<h6 class="user-email">nkosig@gmail.com</h6>
					</div>
					<div class="about">
					    <button type="button" id="change__pp" name="submit" class="update__pp__btn">Change Picture</button>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row gutters">
					...
					<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
						<div class="form-group">
							...
							<input id="username" type="text" class="form-control" value="" id="fullName" placeholder="Gods Plan" readonly/>
						</div>
					</div>
					<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
						<div class="form-group">
							<label for="eMail">Email</label>
							<input id="email" type="email" class="form-control" id="eMail" placeholder="nkosig@gmail.com" readonly/>
						</div>
					</div>
					<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
						<div class="form-group">
							<label for="phone">Phone</label>
							<input id="phone" type="text" class="form-control" id="phone" placeholder="+27 82 123 4581" readonly/>
						</div>
					</div>
				</div>
				<div class="row gutters">
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="update__details__container">
							<button type="button" id="update" name="submit" class="update__details__btn" onclick="update__btn()">Update Details</button>
                            <button type="button" id="save__btn" name="submit" class="save__details__btn">Save</button>
						</div>  
					</div>
				</div>
			</div>
  ...
  <script src="Review_Page/assets/js/Accounts.js"></script>
</form> 
</body>
</html>
