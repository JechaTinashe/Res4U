		...
		<div class="container">			
			<div class="row justify-content-center">
				<div style="background-color:#293558">
					...
					<a style="text-decoration:underline; font-weight:300; color:#B1B3B8" href="ForgotPassword.aspx">Forgot Password?</a>
					...
					<p style="text-align:center; font-weight:300; background-color:#EEF2FE; width:475px; height:30px; border-radius: 10px">Don't have an account? 
						<a style="text-decoration:underline; color:#293558; font-weight:bold" href="SignUp.aspx">Create Account</a></p>		            
		          </form>
		        </div>
		      </div>
				</div>
